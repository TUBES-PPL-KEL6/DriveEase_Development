            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-gray-900">Detail Driver</h2>
                        <div class="flex gap-3">
                            <a href="{{ route('rental.drivers.edit', $driver) }}"
                                class="inline-flex items-center px-4 py-2 bg-yellow-100 rounded-lg font-medium text-yellow-700 border border-yellow-200 hover:bg-yellow-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition">
                            ...
                            <form action="{{ route('rental.drivers.destroy', $driver->id) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="inline-flex items-center px-4 py-2 bg-red-100 rounded-lg text-red-700 font-medium hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    ...
                                                    {{ match ($job->booking->status) {
                                                        'konfirmasi' => 'bg-green-100 text-green-700 border-green-200',
