                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <span
                                    ...
                                    @elseif($booking->status === 'batal') bg-red-900 text-red-200 
                            ...
                            <div class="bg-gray-800 rounded-xl p-4 space-y-2">
                                <h3 class="text-lg font-semibold text-gray-100">Informasi Penyewa</h3>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <p class="text-sm text-gray-400">Nama Lengkap</p>
                                        <p class="text-base font-medium text-gray-100">{{ ucfirst($booking->user->name) }}
                                        </p>
                                    </div>
                                    <div class="space-y-2">
                                        <p class="text-sm text-gray-400">Email</p>
                                        <p class="text-base font-medium text-gray-100">{{ $booking->user->email }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-800 rounded-xl p-4 space-y-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-base font-medium text-gray-100">{{ $booking->vehicle->name }}
                                        </p>
                                    </div>
                                    <div class="space-y-2">
                                ...
                                <div class="bg-gray-800 rounded-xl p-4 space-y-2">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="flex items-center">
                                            ...
                                            <p class="text-base font-medium text-gray-100">{{ $booking->driver->name }}</p>
                                        </span>
                            ...
                            @if (!empty($booking->side_note))
                                <div class="bg-blue-900 border-l-4 border-blue-500 p-4 rounded-lg">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <span class="text-sm text-blue-200"><strong>Catatan:</strong>
            ...
            <div class="modal-content bg-dark text-gray-100">
                ...
                <form action="{{ route('rental.bookings.confirm', $booking->id) }}" method="POST" class="d-inline">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 mt-4">
                            <label for="side_note_confirm" class="block text-sm font-medium text-gray-300">Catatan
                                (opsional)</label>
            ...
            <div class="modal-content bg-dark text-gray-100">
                ...
                <form action="{{ route('rental.bookings.reject', $booking->id) }}" method="POST" class="d-inline">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 mt-4">
                            <label for="side_note_reject" class="block text-sm font-medium text-gray-300">Catatan
                                (opsional)</label>
