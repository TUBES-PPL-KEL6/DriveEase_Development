                ...
                <div class="flex items-center gap-1 text-yellow-500">
                    @for ($i = 1; $i <= 5; $i++)
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l2.234 6.869h7.215c.969 0 1.371 1.24.588 1.81l-5.838 4.245
                    ...
                    <form action="{{ route('user.bookings.store', $vehicle->id) }}" method="POST" class="space-y-3">
                        ...
                        @if (!$userReview)
                            ...
                            <form action="{{ route('reviews.store') }}" method="POST" class="space-y-3 mb-4">
                                ...
                                <button type="submit"
                                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Kirim Ulasan</button>
                            </form>
                        @elseif ($editMode)
                                ...
                                <form action="{{ route('reviews.update', $userReview->id) }}" method="POST">
                                    ...
                                    <div class="block text-sm font-medium space-y-2" id="driver-container">
                                        ...
                                        <div class="flex gap-2">
                                            <select name="driver_id" class="border rounded px-3 py-2 w-full"
                                                id="driver-select">
                                ...
                                <div class="bg-gray-100 p-4 rounded border relative">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span class="text-yellow-500 text-sm font-medium">{{ $review->rating }}
                                                ⭐</span>
