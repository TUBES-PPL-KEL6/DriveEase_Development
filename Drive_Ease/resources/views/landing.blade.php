...
<head>
    ...
    <style>
        ...
        .btn-secondary-custom { /* Tombol sekunder custom */
        ...
        .hero h1 {
            ...
            line-height: 1.2;
            text-shadow: 0 2px 5px rgba(0,0,0,0.5); /* Ditambahkan text-shadow agar lebih terbaca */
        }
        .hero .brand-accent {
            color: #00ffae; /* Menggunakan warna aksen hijau neon Anda agar menonjol dengan teks putih */
            /* text-shadow: 0 0 10px rgba(0,255,174,0.6); /* Efek shadow neon jika diinginkan */
        }
        .hero p.lead {
            font-size: 1.25rem;
            color: #e9ecef; /* DIUBAH menjadi PUTIH KEABUAN (Off-white) */
            max-width: 600px; 
            text-shadow: 0 1px 3px rgba(0,0,0,0.4); /* Ditambahkan text-shadow tipis */
        }
        ...
        .hero .btn-outline-primary {
            color: #FFFFFF; /* Teks putih untuk tombol outline di hero */
            border-color: #FFFFFF; /* Border putih */
        }
        .hero .btn-outline-primary:hover {
            background-color: #FFFFFF;
            color: #0d6efd; /* Teks biru saat hover */
        }
        .hero .btn-explore {
            font-size: 1.1rem;
        ...
        .feature-box .icon { /* Pastikan ada class .icon pada <i> Anda */
            font-size: 3rem;
            color: #0d6efd; 
            margin-bottom: 1rem;
        }
        ...
        /* Testimonial Section */
        #testimonials { /* Nama ID yang benar adalah testimonials, bukan testimoni */
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item"><a class="nav-link" href="#testimonials">Testimoni</a></li> {{-- ID section diganti menjadi testimonials --}}
                <li class="nav-item"><a class="nav-link" href="{{ route('login') }}">Login</a></li>
                <li class="nav-item"><a class="btn btn-primary ms-lg-2 mt-2 mt-lg-0" href="{{ route('register') }}">Daftar Gratis</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7" data-aos="fade-right" data-aos-delay="100">
                <h1 class="display-3 fw-bolder">Sewa Mobil Impian Anda, <br class="d-none d-md-block"> <span class="brand-accent">Mudah & Aman</span> Bersama DriveEase</h1>
                <p class="lead my-4">
                    Platform terpercaya untuk menemukan dan menyewa berbagai jenis mobil dengan proses cepat, transparan, dan harga terbaik. Mulai petualangan Anda hari ini!
                </p>
                <a href="{{ route('register') }}" class="btn btn-primary btn-lg btn-explore shadow-lg me-2 mb-2 mb-sm-0" data-aos="zoom-in" data-aos-delay="300">
                    <i class="bi bi-box-arrow-in-right me-2"></i>Daftar Sekarang
                </a>
                <a href="#features" class="btn btn-outline-primary btn-lg btn-explore shadow-lg mb-2 mb-sm-0" data-aos="zoom-in" data-aos-delay="400">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="feature-box text-center">
                    ...
                    <p>Cari, bandingkan, dan sewa kendaraan favorit Anda langsung dari perangkat mana pun, kapan pun.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-box text-center">
                    ...
                    <p>Tersedia QRIS, e-wallet, virtual account, dan transfer bank. Pilih yang paling nyaman untuk Anda.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="feature-box text-center">
                    ...
                    <p>Lihat review dan rating dari pengguna lain. Semua transaksi diverifikasi untuk keamanan Anda.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4" data-aos="fade-right" data-aos-delay="100">
                <div class="testimonial-card">
                    <p class="quote">“DriveEase benar-benar game-changer! Proses sewa mobil jadi super mudah dan cepat. Website-nya intuitif banget, pilihan mobilnya juga banyak. Highly recommended!”</p>
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial-card">
                    <p class="quote">“Awalnya ragu sewa mobil online, tapi DriveEase membuktikan keamanannya. Konfirmasi instan, mobil sesuai deskripsi. Liburan keluarga jadi makin seru!”</p>
                     <div class="mt-auto text-end">
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-left" data-aos-delay="300">
                <div class="testimonial-card">
                    <p class="quote">“Pembayaran pakai QRIS praktis banget! Gak perlu ribet transfer manual lagi. Customer servicenya juga responsif. Pasti bakal sewa di sini lagi.”</p>
                     <div class="mt-auto text-end">
...
--}}
<section class="py-5 text-center text-white" style="background-image: linear-gradient(to right, var(--bs-primary), var(--bs-indigo));" data-aos="zoom-in">
    <div class="container">
        <h2 class="display-5 fw-bold mb-3">Siap Memulai Perjalanan Anda?</h2>
        <p class="lead mb-4 mx-auto" style="max-width: 600px;">
            Jangan tunda lagi! Temukan kendaraan yang sempurna untuk petualangan atau kebutuhan bisnis Anda berikutnya dengan DriveEase.
        </p>
        <a href="{{ route('register') }}" class="btn btn-light btn-lg shadow-lg me-2 transform hover:scale-105 transition-transform">
            <i class="bi bi-person-plus-fill me-2"></i>Daftar Sekarang
        </a>
        <a href="{{ route('vehicles.index') }}" class="btn btn-outline-light btn-lg shadow-lg transform hover:scale-105 transition-transform">
