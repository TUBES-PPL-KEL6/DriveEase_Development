        ...
        <div class="space-x-4">
            @auth
                ...
                @elseif(auth()->user()->role === 'rental')
                    ...
                    <a href="{{ route('reviews.owner_dashboard') }}" class="text-sm hover:text-blue-600">Ulasan Kendaraan</a>
                @elseif(auth()->user()->role === 'admin')
                    <a href="{{ route('admin.dashboard') }}" class="text-sm hover:text-blue-600">Dashboard Admin</a>
                    <a href="{{ route('admin.reviews.index') }}" class="text-sm hover:text-blue-600">Moderasi Ulasan</a>
                @endif
