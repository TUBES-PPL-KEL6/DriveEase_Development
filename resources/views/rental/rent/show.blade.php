<x-app-layout>
    ...
    @if ($rent->status === 'selesai' && Auth::id() === $rent->rental_id)
        <div class="mt-8 bg-white rounded-xl shadow-sm p-6">
            <h3 class="text-lg font-semibold mb-4">Beri Ulasan untuk Penyewa</h3>
            <form action="{{ route('customer-reviews.store', $rent->id) }}" method="POST">
                @csrf
                <div class="mb-3">
